        ...
        <div class="container pt-30">
            <div class="flex justify-between ">
                <div class="w-5/12">
                    ...
                    <p class="sec-text mt-5! ">
                        Various versions have evolved over the years, sometimes by
                        accident, sometimes on purpose injected humour and the like.
                    </p>
                    <div class="flex items-center gap-15 mt-5">
                        <div>
                            <h3 class="text-2xl font-medium pb-1">10m+</h3>
                            <p class="text-[15px]">Happy People</p>
                        </div>
                        <div>
                            <h3 class="text-2xl font-medium pb-1">4.88</h3>
                            <p class="text-[15px]">Overall rating</p>
                        </div>
                    </div>
                </div>
                <Carousel v-bind="testiconfig" class="w-5/12 client-says relative">
                    <Slide>
                        <div class="carousel__item" >
                            <div class="flex items-center gap-4">
                                <img src="/img/users/user1.png" alt="user1" class="w-15 h-full">
                                <div>
                                    <p class="text-darkText font-medium">Cameron Williamson</p>
                                    <span class="text-sm">Designer</span>
                                </div>
                            </div>
                            <p class="text-base mt-7  font-medium ">
